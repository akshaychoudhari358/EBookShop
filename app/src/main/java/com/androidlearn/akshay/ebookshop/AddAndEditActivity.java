...
import com.androidlearn.akshay.ebookshop.databinding.ActivityAddAndEditBinding;
        ...
        public class AddAndEditActivityClickHandlers{
            ...
            public void onSubmitButtonClicked(View view){
                if(book.getBookName() == null){
                    Toast.makeText(context, "Name field can not be empty", Toast.LENGTH_LONG).show();
                }else {
