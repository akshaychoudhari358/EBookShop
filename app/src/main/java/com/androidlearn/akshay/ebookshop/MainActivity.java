...
import com.androidlearn.akshay.ebookshop.databinding.ActivityMainBinding;
import com.androidlearn.akshay.ebookshop.model.Book;
import com.androidlearn.akshay.ebookshop.model.Category;
import com.androidlearn.akshay.ebookshop.viewmodel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class MainActivityClickHandlers {
        ...
        public void onSelectItem(AdapterView<?> parent, View view, int pos, long id) {
            ...
            Toast.makeText(parent.getContext(), "Category = "+selectedCategory.getId(), Toast.LENGTH_LONG).show();
